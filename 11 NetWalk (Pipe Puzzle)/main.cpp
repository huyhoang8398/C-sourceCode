...
int main()
{
    ...
    Texture t1,t2,t3,t4;
    t1.loadFromFile("/Users/huyhoang8398/C-GameSourceCode/11 NetWalk (Pipe Puzzle)/images/background.png");
    t2.loadFromFile("/Users/huyhoang8398/C-GameSourceCode/11 NetWalk (Pipe Puzzle)/images/comp.png");
    t3.loadFromFile("/Users/huyhoang8398/C-GameSourceCode/11 NetWalk (Pipe Puzzle)/images/server.png");
    t4.loadFromFile("/Users/huyhoang8398/C-GameSourceCode/11 NetWalk (Pipe Puzzle)/images/pipes.png");
    t4.setSmooth(true);
