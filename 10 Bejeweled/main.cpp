...
int main()
{
    ...
    Texture t1,t2;
    t1.loadFromFile("/Users/huyhoang8398/C-GameSourceCode/10 Bejeweled/images/background.png");
    t2.loadFromFile("/Users/huyhoang8398/C-GameSourceCode/10 Bejeweled/images/gems.png");
