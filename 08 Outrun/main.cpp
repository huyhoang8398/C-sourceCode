...
int main()
{
    ...
    for(int i=1;i<=7;i++)
     {
       t[i].loadFromFile("/Users/huyhoang8398/C-GameSourceCode/08 Outrun/images/"+std::to_string(i)+".png");
       t[i].setSmooth(true);
       object[i].setTexture(t[i]);
     }

    Texture bg;
    bg.loadFromFile("/Users/huyhoang8398/C-GameSourceCode/08 Outrun/images/bg.png");
    bg.setRepeated(true);
